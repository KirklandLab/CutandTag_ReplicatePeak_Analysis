...
```
wget https://github.com/KirklandLab/CutandTag_ReplicatePeak_Analysis/releases/download/v1.3.0/CutandTag_ReplicatePeak_Analysis-1.3.0.tar.gz
tar -xzf CutandTag_ReplicatePeak_Analysis-1.3.0.tar.gz
rm CutandTag_ReplicatePeak_Analysis-1.3.0.tar.gz
cd CutandTag_ReplicatePeak_Analysis-1.3.0
```
9B. Load modules
```
module purge
