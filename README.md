...
# 2) Intended Use Case
This pipeline is ideal for researchers who have already processed their Cut-and-Tag data through preliminary steps such as quality control, alignment, and filtering (e.g., by using [CutandTag_Analysis_Snakemake](https://github.com/KirklandLab/CutandTag_Analysis_Snakemake)). After obtaining high-quality aligned BAM files, you can use CutAndTag_ReplicatePeak_Analysis to:
...
```
wget https://github.com/KirklandLab/CutandTag_ReplicatePeak_Analysis/releases/download/v1.0.5/CutandTag_ReplicatePeak_Analysis-1.0.5.tar.gz
